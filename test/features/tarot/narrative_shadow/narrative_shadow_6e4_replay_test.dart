/// Phase 6E.4 — client assessor enrichment + replay for Manifest V2 results.
...
const _qaRunHead = '6e2fa96ab1ca0bfc48f2ac7a84a3a6557a7dee92';
...
void main() {
  test('6E.4 enrich client assessment fields on captured results', () {
    ...
    for (final call in calls) {
      ...
      final assessment = NarrativeTarotShadowResultAssessor.assess(
        request: req,
        rawResult: map,
        requestId: 'qa6e4_${call['callNumber']}',
  ...
  test('6E.4 replay — typed failures preserved; no fabricated results', () {
