/// Phase 6E.8 Sol — client assessor enrichment + replay for Manifest V2 results.
...
const _qaRunHead = 'c342ab8f8813423cb162888f5089e6fabbf955a6';
...
void main() {
  test('6E.8 Sol enrich client assessment fields on captured results', () {
    ...
    for (final call in calls) {
      ...
      final assessment = NarrativeTarotShadowResultAssessor.assess(
        request: req,
        rawResult: map,
        requestId: 'qa6e8_sol_${call['callNumber']}',
  ...
  test('6E.8 Sol replay — typed failures preserved; no fabricated results', () {
