/// Phase 6E.4.2 — client assessor enrichment + replay for Manifest V2 results.
...
const _qaRunHead = '2799e9bf518b2e1db6e9ce338643bffef8c4e632';
...
void main() {
  test('6E.4.2 enrich client assessment fields on captured results', () {
    ...
    for (final call in calls) {
      ...
      final assessment = NarrativeTarotShadowResultAssessor.assess(
        request: req,
        rawResult: map,
        requestId: 'qa6e42_${call['callNumber']}',
  ...
  test('6E.4.2 replay — typed failures preserved; no fabricated results', () {
