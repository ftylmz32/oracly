/// E3F — render real Coffee/Palm provider envelopes in result widgets.
library;
...
void main() {
  ...
  testWidgets('E3F coffee live envelope renders without overflow', (tester) async {
    final envelope = jsonDecode(
      File('tool/e3e_private/evidence/coffee_analysis_e3f_response.json')
          .readAsStringSync(),
  ...
  testWidgets('E3F palm live envelope renders without overflow', (tester) async {
    final envelope = jsonDecode(
