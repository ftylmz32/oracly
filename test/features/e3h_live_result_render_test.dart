/// E3H — render real Coffee/Palm two-stage envelopes in result widgets.
library;
...
void main() {
  ...
  testWidgets('E3H coffee live envelope renders without overflow', (tester) async {
    final envelope = jsonDecode(
      File('tool/e3e_private/evidence/coffee_analysis_e3h_response.json')
          .readAsStringSync(),
  ...
  testWidgets('E3H palm live envelope renders without overflow', (tester) async {
    final envelope = jsonDecode(
      File('tool/e3e_private/evidence/palm_analysis_e3h_response.json')
          .readAsStringSync(),
    ) as Map<String, dynamic>;
    expect(envelope['success'], isTrue);
    final data = Map<String, dynamic>.from(envelope['data'] as Map);
