...
const kL10nPremium = <String, L10nTriple>{
  ...
  'premium.app_bar_title': L10nTriple('PREMİUM', 'PREMIUM', 'ПРЕМИУМ'),
  'premium.status_active_label': L10nTriple('AKTİF', 'ACTIVE', 'АКТИВНО'),
  'premium.status_premium_label': L10nTriple('PREMIUM', 'PREMIUM', 'ПРЕМИУМ'),
  'premium.plan_selected_label': L10nTriple('Seçildi', 'Selected', 'Выбрано'),
  ...
  'premium.experiences_title': L10nTriple(
    'Premium deneyimler',
    'Premium experiences',
    'Премиум-опыты',
  ),
  'premium.included_title': L10nTriple(
    'Ücretsiz kalanlar',
    'What stays free',
  ...
  'premium.benefit.soulmate.title': L10nTriple(
    'Ruh Eşi',
    'Soulmate',
    'Родственная душа',
  ),
  ...
  'premium.benefit.discovery.title': L10nTriple(
    'Keşif Günlüğü',
    'Discovery journal',
    'Дневник открытий',
  ),
  ...
  'premium.benefit.or.title': L10nTriple(
    'OR sohbeti',
    'OR conversation',
    'Разговор с OR',
  ),
  ...
  'premium.benefit.atmosphere.title': L10nTriple(
    'Günün Mesajı',
    "Today's message",
    'Послание дня',
  ),
  ...
  'premium.benefit.depth.title': L10nTriple('Derinlik', 'Depth', 'Глубина'),
  ...
  'premium.entitlement_network_error': L10nTriple(
    'Üyelik durumuna şu anda ulaşılamıyor. Bağlantını kontrol edip yeniden dene.',
    'We could not reach the store to check your membership right now. Check your connection and try again.',
    'Не удалось проверить подписку прямо сейчас. Проверь подключение и попробуй снова.',
  ),
  'premium.entitlement_bound_other_account': L10nTriple(
    'Bu satın alma başka bir hesaba bağlı görünüyor.',
    'This purchase appears to be linked to a different account.',
    'Похоже, эта покупка привязана к другому аккаунту.',
  ),
  'premium.entitlement_missing_credentials': L10nTriple(
    'Satın alma bilgin bulunamadı. Satın almaları geri yüklemeyi dene.',
    'We could not find your purchase details. Try restoring your purchases.',
    'Не удалось найти данные покупки. Попробуй восстановить покупки.',
  ),
  ...
  'premium.gem_section_title': L10nTriple('Mücevher', 'Gem', 'Кристалл'),
  ...
  'premium.plan_price_pending': L10nTriple(
    'Mağaza fiyatı',
    'Store price',
    'Цена магазина',
  ),
  'premium.cta_restore': L10nTriple(
    'Satın Almaları Geri Yükle',
    'Restore purchases',
    'Восстановить покупки',
  ),
  'premium.cta_busy': L10nTriple('Hazırlanıyor…', 'Preparing…', 'Готовится…'),
  'premium.activated': L10nTriple(
    'Premium üyeliğin doğrulandı.',
    'Your Premium membership was confirmed.',
    'Премиум-подписка подтверждена.',
  ),
  'premium.purchase_failed': L10nTriple(
    'Satın alma işlemi tamamlanamadı.',
    'The purchase could not be completed.',
    'Покупку не удалось завершить.',
  ),
  'premium.purchase_cancelled': L10nTriple(
  ...
  'premium.restore_failed': L10nTriple(
    'Satın almalar geri yüklenemedi.',
  ...
  'premium.restore_success': L10nTriple(
  ...
  'premium.plan_monthly': L10nTriple(
    'Esnek başlangıç',
    'Flexible start',
    'Гибкое начало',
  ),
  'premium.plan_yearly': L10nTriple(
    'Yıllık plan',
    'Yearly plan',
    'Годовой план',
  ),
