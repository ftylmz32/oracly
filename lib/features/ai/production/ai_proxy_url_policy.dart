/// Proxy URL policy - reject developer networking in locked builds.
library;

abstract final class AiProxyUrlPolicy {
  AiProxyUrlPolicy._();

  /// Production / staging / release binaries must not use developer hosts.
  ...
  /// RFC1918 / link-local — valid for LAN device testing only.
