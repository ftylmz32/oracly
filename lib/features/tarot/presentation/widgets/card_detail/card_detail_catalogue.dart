...
abstract final class CardDetailCatalogue {
  ...
  static final List<CardDetailContent> _cards = [
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/02-TheHighPriestess.png',
      arcanaType: 'Major Arcana',
      element: 'Su',
      planet: 'Ay',
      zodiac: 'Balık',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/03-TheEmpress.png',
      arcanaType: 'Major Arcana',
      element: 'Toprak',
      planet: 'Venüs',
      zodiac: 'Boğa',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/04-TheEmperor.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Mars',
      zodiac: 'Koç',
    ...
    CardDetailContent(
      ...
      name: 'The Hierophant',
      displayNameTr: 'Aziz',
      imageAsset: '$_root/05-TheHierophant.png',
      arcanaType: 'Major Arcana',
      element: 'Toprak',
      planet: 'Venüs',
      zodiac: 'Boğa',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/07-TheChariot.png',
      arcanaType: 'Major Arcana',
      element: 'Su',
      planet: 'Ay',
      zodiac: 'Yengeç',
    ...
    CardDetailContent(
      ...
      name: 'Strength',
      displayNameTr: 'Güç',
      imageAsset: '$_root/08-Strength.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Güneş',
      zodiac: 'Aslan',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/10-WheelOfFortune.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Jüpiter',
      zodiac: 'Yay',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/11-Justice.png',
      arcanaType: 'Major Arcana',
      element: 'Hava',
      planet: 'Venüs',
      zodiac: 'Terazi',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/12-TheHangedMan.png',
      arcanaType: 'Major Arcana',
      element: 'Su',
      planet: 'Neptün',
      zodiac: 'Balık',
    ...
    CardDetailContent(
      ...
      name: 'Temperance',
      displayNameTr: 'Denge',
      imageAsset: '$_root/14-Temperance.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Jüpiter',
      zodiac: 'Yay',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/15-TheDevil.png',
      arcanaType: 'Major Arcana',
      element: 'Toprak',
      planet: 'Satürn',
      zodiac: 'Oğlak',
    ...
    CardDetailContent(
      ...
      name: 'The Tower',
      displayNameTr: 'Kule',
      imageAsset: '$_root/16-TheTower.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Mars',
      zodiac: 'Mars',
    ...
    CardDetailContent(
      ...
      imageAsset: '$_root/20-Judgement.png',
      arcanaType: 'Major Arcana',
      element: 'Ateş',
      planet: 'Plüton',
      zodiac: 'Akrep',
    ...
    CardDetailContent(
      ...
      name: 'The World',
      displayNameTr: 'Dünya',
      imageAsset: '$_root/21-TheWorld.png',
      arcanaType: 'Major Arcana',
      element: 'Toprak',
      planet: 'Satürn',
      zodiac: 'Oğlak',
