/// Locale-native output format instructions - same craft, native wording.
library;
...
abstract final class OutputFormatLocale {
  ...
  static const _standardEn = r'''Write a natural reading. No mandatory heading skeleton.
It may be short or longer when needed. Do not force bullet lists.
No certainty and no prophecy. If data is thin, write less.
''';

  static const _standardRu = r'''Пиши естественное чтение. Без обязательного каркаса заголовков.
Может быть коротким или длиннее, если нужно. Не навязывай списки.
Нет уверенности и пророчества. Мало данных - пиши меньше.
''';

  static const _astrologyEn = r'''Give clear observation. Do not end with a question. Do not hand the work back.
...
''';
  ...
  static const _astrologyRu = r'''Дай ясное наблюдение. Не заканчивай вопросом. Не оставляй работу человеку.
...
''';
  ...
  static const _dreamEn = r'''Write one story. No mandatory heading rain.
Visible image -> possible link -> soft reading. No glossary entry.
No certainty. Do not end every reply with a question.
''';

  static const _dreamRu = r'''Пиши одну историю. Без обязательного дождя заголовков.
