            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Center(child: AstrologyReferenceKindNote(compact: true)),
                  SizedBox(height: AstrologyReferenceTokens.leadToStrip - 6),
                  Expanded(
                    child: LayoutBuilder(
                      builder: (context, constraints) =>
                          OraclyAdaptiveScrollView(
                        // Local sun-sign reading never depends on profile load.
                        child: isLoading
